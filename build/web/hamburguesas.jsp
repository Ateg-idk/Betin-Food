    ...
    <body >
        ...
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="index.jsp" style="text-decoration: none; color: #212529;">Comidas</a>
                </li>
                <li class="breadcrumb-item active" aria-current="page">Hamburguesas</li>
            </ol>
        </nav>
        ...
        <div class="container mt-3 mb-3">
            ...
            <div class="row mb-4 justify-content-center">
                ...
                <div class="col-12 col-lg-4 text-center col-sm-6">
                    <div class="card">
                        <img src="<%= hamburguesa.getFotoHamburguesa() %>" class="card-img-top" alt="...">
                        <div class="card-body">
